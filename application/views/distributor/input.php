<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<form action="<?php echo base_url().'distributor/proses_input' ?>" enctype="multipart/form-data" method="post" role="form">
			<legend>Tambahkan Distributor</legend>
			...
			<table class="table table-stripped table-putih">
				<tbody>
					...
					<tr>
						<td>Email</td>
						<td><input type="text" name="e" id="inputG" class="form-control" required="required"></td>
					</tr>
					<tr>
